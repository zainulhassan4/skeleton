                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="name">Post Page</label>
                                <select class="form-control" name="page_id">
                                    <option value=""></option>
                                    @foreach(TCG\Voyager\Models\Page::all() as $page)
                                        <option value="{{ $page->id }}" @if(isset($dataTypeContent->page_id) && $dataTypeContent->page_id == $page->id){{ 'selected="selected"' }}@endif>{{ $page->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
